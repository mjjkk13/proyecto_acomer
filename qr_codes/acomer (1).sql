...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-09-2024 a las 07:29:29
...
(21, 'Jose', '$2y$10$Cw2ko3.jIBxGp342onHTGOqYopqbPeeDE.zwKHK0UXrEED5RTncse', '2024-09-12 22:48:25', '2024-09-12 23:31:41', 1),
(103, 'Marcel', '$2y$10$SCnYIXoq5jE2grtravqWD.wmdnYvlvcvfcyMij4mpvZHESfchjJCm', '2024-09-12 23:53:50', '0000-00-00 00:00:00', 1),
(104, 'Mayerli', '$2y$10$1LwHEN2VjETknHXqR4WAA.w9rXF/mVU4QNAzmbEVdNgBjSkqlcPF2', '2024-09-12 23:55:44', '0000-00-00 00:00:00', 1),
(106, 'Jessica', '$2y$10$ir7GaQoY2SMSzQyDr6Yqm..szZ6aCEqET0k5oV2caD.6eS1bC5ate', '2024-09-12 23:57:53', '0000-00-00 00:00:00', 1),
(111, 'Santiago', '$2y$10$KrjzKf52MwdsXSWwiMfvHONcvGTlVbNSXV.092jCjBg2RrnbHbSCa', '2024-09-13 00:19:28', '0000-00-00 00:00:00', 1),
(113, 'Mariana', '$2y$10$kHN5DOnIUJJxX2GgcT0yKu3SNMs0Losp7fHFVbvvmp9GTbmAYlafa', '2024-09-13 00:23:41', '0000-00-00 00:00:00', 1),
...
(11, 'Curso 1105', 7, 25, 'CC', 2, 0, NULL, NULL);
...
(117, 'Mariana', 'Jimenez', 'marianajimenezv2006@gmail.com', '', '3005556987', 'Suba', 1035698765, 'CC', 3, 113),
...
--
ALTER TABLE `alumnos`
  MODIFY `idalumnos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `credenciales`
  MODIFY `idcredenciales` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
...
--
ALTER TABLE `docentealumnos`
  MODIFY `iddocentealumnos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `usuarios`
  MODIFY `idusuarios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=122;

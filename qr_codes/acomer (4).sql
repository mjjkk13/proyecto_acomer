...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-08-2024 a las 20:49:52
...
(2, '2024-08-27', 0, 102, 23, 2, 'TI', 1, 2, 0),
(3, '2024-08-27', 1, 103, 24, 3, 'CC', 1, 3, 0);
...
ALTER TABLE `asistencia`
  ...
  ADD KEY `fk_asistencia_usuarios1_idx` (`usuarios_idusuarios`,`usuarios_tipo_documento_tdoc`,`usuarios_tipo_usuario_idtipo_usuario`,`usuarios_credenciales_idcredenciales`,`usuarios_docente_iddocente`);
...
ALTER TABLE `asistencia`
  ...
  ADD CONSTRAINT `fk_asistencia_usuarios1` FOREIGN KEY (`usuarios_idusuarios`,`usuarios_tipo_documento_tdoc`,`usuarios_tipo_usuario_idtipo_usuario`,`usuarios_credenciales_idcredenciales`,`usuarios_docente_iddocente`) REFERENCES `usuarios` (`idusuarios`, `tipo_documento_tdoc`, `tipo_usuario_idtipo_usuario`, `credenciales_idcredenciales`, `docente_iddocente`);
